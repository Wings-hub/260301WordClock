...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/Database}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/FeatureExplorer.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/Interpretation.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/Interpretation}
...
\begin{itemize}[leftmargin=1.5cm]
	...
	\begin{figure}
		\begin{center}
			...
			\includegraphics[width=0.4\linewidth]{AppFaceAccess/PortentaH7Connected}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/RunImpulse}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/DebugImpulse}
		\caption{Debug Mode}
		\label{debug}
	\end{center}
\end{figure}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/RetrainModel.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/Dataset.png}
...
\begin{itemize}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{EdgeImpulse/Nodejs}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/DataLabel}
...
and height to 160X160 pixel and Resize mode to 'Fit longest', because it offers enough resolution to capture important facial features while being small enough to run efficiently on the Portenta H7. We can reduce the pixel further if we need faster inference. Then in the pre-processing block, select the 'Image'. The image pre-processing block takes input image and can optionally convert it into grayscale and then turns the data into a features array. Then we need to add a learning block and select 'Transfer Learning (images)'. Finally, save the impulse as shown in the figure ~\ref{Impulse}.
 ...
 \begin{figure}
 	\begin{center}
 		\includegraphics[width=0.7\linewidth]{EdgeImpulse/ImpulseDesign}
 ...
 \begin{figure}
 	\begin{center}
 		\includegraphics[width=0.7\linewidth]{EdgeImpulse/FeatureExtract}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/GenerateFeatures}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/TransferLearning}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/ModelTest}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/LiveClassify}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/ModelDeployment}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/AddZIP}
...
\begin{figure}
	\begin{center}
 \includegraphics[width=0.7\linewidth]{EdgeImpulse/FaceRecognition}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/Vijay}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/Uncertain}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{EdgeImpulse/API}
		\caption{API key}
		\label{API}
	\end{center}
\end{figure}
