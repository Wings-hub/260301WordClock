...
image, label = example["image"], example["label"]
  ...
  \item [\href{https://www.kdnuggets.com/datasets}{KDnuggets.com:}] Ähnlich wie Kaggle aufgebaut; allerdings wird hier auf andere Webseiten verwiesen.
  ...
  \item \href{http://vis-www.cs.umass.edu/lfw/}{faces:} Labeled Faces in the Wild ist ein öffentlicher Benchmark für die Gesichtsverifizierung, auch bekannt als Paarvergleich. Unabhängig von der Leistung eines Algorithmus sollte daraus nicht geschlossen werden, dass ein Algorithmus für einen kommerziellen Zweck geeignet ist.
