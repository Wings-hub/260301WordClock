...
\begin{figure}[htb]
  ...
  \begin{subfigure}{.5\linewidth}
     ...
     \includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager1}
  \end{subfigure}[b]
  \begin{subfigure}{.5\linewidth}  
    \caption{Auswahl der Distribution}\label{fig:face-output}
    \includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager2}
  \end{subfigure}
  \begin{subfigure}{.5\linewidth}
    \caption{Auswahl des Images}\label{fig:face-input}\includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager3.PNG}
  \end{subfigure}
  \begin{subfigure}{.5\linewidth}
	\caption{Auswahl des Speichermediums (1)}\label{fig:face-output}\includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager4.PNG}
  \end{subfigure}
  \begin{subfigure}{.5\linewidth}
	\caption{Auswahl des Speichermediums (2)}\label{fig:face-input}\includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager5.PNG}
  \end{subfigure}
  \begin{subfigure}{.5\linewidth}
	\caption{Bestätigung}\label{fig:face-output}\includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager6.PNG}
  \end{subfigure}
  \begin{subfigure}{.5\linewidth}
	\caption{Fortschrittsanzeige}\label{fig:face-input}\includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager7.PNG}
  \end{subfigure}
  \begin{subfigure}{.5\linewidth}
	\caption{Finaler Bildschirm}\label{fig:face-output}\includegraphics[width=.48\textwidth]{../Images/RaspberryPi/piimager8.PNG}
 \end{subfigure}
