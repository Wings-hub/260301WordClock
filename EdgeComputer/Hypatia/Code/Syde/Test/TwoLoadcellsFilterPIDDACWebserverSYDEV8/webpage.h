...
<body>
  <div class="container">
    ...
    <div class="frame-container">
      ...
      <div class="frame">
        ...
        <input type="number" id="B" name="B" value="0" min="0" max="3500"><br><br>

        <label for="conv">Valore 0-4095 per ottenere 1500 mV in uscita dal DAC quando l'ingresso sta all'interno di B (mV):</label><br>
        <input type="number" id="conv" name="conv" value="1500" min="0" max="3300"><br><br>
  ...
  <script>
    ...
    function sendPIDeBSettings() {
      ...
      fetch(`/set?p=${p}&kp1=${kp1}&kd1=${kd1}&kp2=${kp2}&kd2=${kd2}&B=${B}&conv=${conv}`);
    }
  </script>
</body>
</html>
