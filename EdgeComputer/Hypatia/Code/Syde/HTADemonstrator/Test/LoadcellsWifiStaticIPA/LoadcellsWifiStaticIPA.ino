...
IPAddress local_IP(192, 168, 11, 184);     // Eine freie IP im selben Subnetz, z. B. .184
IPAddress gateway(192, 168, 10, 1);        // Dein Router (Standardgateway)
...
float start1() {
    return myScale1.get_units(10);
}

float start2() {
    return myScale2.get_units(10);
}
