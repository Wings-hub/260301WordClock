...
\begin{center}
    \begin{tikzpicture}
        \node (G) at (0,0) {\includegraphics[width=11cm]{Syde/ESP32Installation}};
...
\begin{center}
    \begin{tikzpicture}
        \node (G) at (0,0) {\includegraphics[width=8cm]{Syde/ESP32Wroom1}};
    ...
    \begin{center}
      \begin{tikzpicture}
        \node (G) at (0,0) {\includegraphics[width=8cm]{Syde/ESP32Wroom12}};
...
\begin{center}
  \includegraphics[width=8cm]{Syde/InstallationState.JPG};
...

{
    ...
    \ArduinoExternal{}{../../Code/Syde/Test/TestRGB/TestRGB.ino}
}
...
\begin{center}
    \includegraphics[width=8cm]{Syde/LibAdaFruitNeoPixel};
...
\begin{center}
    \includegraphics[width=11cm]{Syde/Donwloaded};
...
\begin{center}
    \includegraphics[width=4cm,angle=90]{Syde/TestRGB};
...
\begin{enumerate}
  ...
  \item  If you get the error ``COM Port not found/not available'', you might need to check the port:
    ...
    \begin{itemize}
      \item Open Window's device manager using  \keys{\faWindows + X}.
