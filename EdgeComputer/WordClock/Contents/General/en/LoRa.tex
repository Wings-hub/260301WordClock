...
\chapter{LoRa \label{lora:general}}
	Dieses Kapitel beschreibt die physikalischen Grundlagen der \acf{lora}-Modulation, einschließlich Spreading Factor, Bandbreite, Coding Rate und deren Einfluss auf Reichweite, Datenrate und Robustheit. Es erläutert zentrale Leistungsparameter wie Sendeleistung, Empfindlichkeit, RSSI, SNR und Link-Budget, sowie regulatorische Aspekte wie Duty-Cycle-Beschränkungen im EU-Frequenzband. Zusätzlich wird das Funktionsprinzip der Chirp-Spread-Spectrum-Modulation, der Aufbau eines \acs{lora}-Pakets und die Demodulation mittels Dechirping und schnelle Fourier-Transformation (FFT) dargestellt.
...
\subsection{RSSI in LoRa}
	Die Erläuterung des RSSI-Parameters erfolgt bei \citeauthor{Semtech:2015b} in der Dokumentation \citetitle{Semtech:2015b}.
