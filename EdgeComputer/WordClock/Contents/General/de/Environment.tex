...
\begin{figure}
	\GRAPHICSC{0.4}{1.0}{Images/Environment/Env4}	
...
%todo eigene Datei einfügen     
  	\begin{figure}
  	\GRAPHICSC{0.6}{1.0}{Images/Environment/Env6}	
...
\begin{figure}
	\GRAPHICSC{0.6}{1.0}{Images/Environment/Env7}	
...
\begin{figure}
	\GRAPHICSC{0.3}{1.0}{Images/Environment/Env10}	
...
\begin{figure}
	\GRAPHICSC{0.3}{1.0}{Images/Environment/Env11}	
...
%
%  	\begin{figure}
%	\GRAPHICSC{0.3}{1.0}{Images/Environment/Env13}	
%	
%	\caption{Anaconda Navigator: Erstellung einer virtuellen Umgebung}
%	
%	\label{fig:env13}  
