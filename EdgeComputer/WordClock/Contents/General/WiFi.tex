...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{WiFi/FullInterface.png}
...
\begin{itemize}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/SetUpServer}
			\caption{SetUpServer}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/BasicSetup.png}
			\caption{BasicSetup}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/LEDState.png}
			\caption{LEDState}
...

	{
		...
		\ArduinoExternal{}{../../Code/Arduino/Wifi/SimpleWebServer/SimpleWebServer.ino}
	}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/NewTab}
			\caption{NewTab}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/NamingNewTab}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/HeaderFile.png}
			\caption{HeaderFile}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/Uplaoding.png}
			\caption{Uplaoding}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/SerialMonitor.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/PortentaAccessPoint.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/URLAccessPoint.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/HTML Page.png}
			\caption{HTML Page}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/ClientDetails.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{WiFi/GETRequest.png}
			\caption{GETRequest}
