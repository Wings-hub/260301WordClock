...
\newcommand{\lorapcbLayout}{
	\node[anchor=south west] (img) at (0,0) {	\includegraphics[width=11cm]{LoRaPCB/PCBforMKRWAN1310}};
...
\newcommand{\ArduinoMkrWan}[5]{
	\begin{scope}[shift={(#3, #4)}]	
		...
		\begin{scope}[scale=#1, rotate=#2, transform shape]			
			...
			%\node[anchor=center, inner sep=0pt, opacity=0.3] at (0,0) {\includegraphics[width=20cm, angle=270]{../Images/MKRWAN1310/mkrwan1310}};
		\end{scope}
	\end{scope}
}
...
\newcommand{\mainModule}{
	...
	% PCB Board
	%\node[anchor=south west, inner sep=0pt] at (0.3,2) {\includegraphics[width=5cm, angle=90]{Images/LoRaPCB/PCBforMKRWAN1310}};
...
\newcommand{\mainModuleInternal}{
	...
	% PCB Board
	\node[anchor=south west, inner sep=0pt] at (1.2,5.2) {\includegraphics[width=5cm, angle=270]{LoRaPCB/PCBforMKRWAN1310}};
...
\newcommand{\routerPlatform}[4]{
	\begin{scope}[shift={(#3, #4)}]
		...
		\begin{scope}[scale=#1, rotate=#2]
			...
			% Background template picture -> edit in scale 1
			%\node[anchor=center, inner sep=0pt, opacity=0.3] at (0,0) {\includegraphics[width=10cm, angle=0]{../Images/LoRaAndLoRaWAN/Gateway/MikrotikCard.jpeg}};
		\end{scope}
	\end{scope}
}
