...
\begin{titlepage}
	...
	{\hspace{-50mm}\vspace{-10mm}\includegraphics[width=220mm,height=80mm]{Allgemein/LogoDataScienceRot.jpg}};
	...
	{\hspace{-50mm}%\vspace{-30mm}
		\begin{tikzpicture}
			...
			\node[black,right] (Name) at (3,3) {\Huge \textsf{N.N.}};
			\node[white,right] (Title) at (3,1) {\Huge \textsf{Hypatia}};
			\node[white,right] (Title) at (3,0) {\LARGE \textsf{Word Clock}};
