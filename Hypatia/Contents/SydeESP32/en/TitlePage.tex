...
\begin{titlepage}
	...
	{\hspace{-50mm}\vspace{-10mm}\includegraphics[width=220mm,height=80mm]{../../Images/Allgemein/LogoDataScienceYellow}};
	...
	{\hspace{-50mm}%\vspace{-30mm}
		\begin{tikzpicture}
			...
			\node[black,right] (Title) at (3,1) {\Huge \textsf{Syde's ESP32 Hypatia}};
