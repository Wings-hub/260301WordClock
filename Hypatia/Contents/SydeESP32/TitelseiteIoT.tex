...
\begin{titlepage}
	...
	{\includegraphics[]{../Images/Syde/syde}};
	...
	{\hspace{-50mm}%\vspace{-30mm}
		\begin{tikzpicture}
			...
			\node[black,right] (Name) at (3,3) {\Huge \textsf{Ecosensors IoT-Systems Description}};
			\node[white,right] (Title) at (3,1) {\Huge \textsf{\TRANS{Anleitung zur Installation und Konfiguration der IoT-Systeme für das Hypatia Board}{Manual to install and configure the IoT- Systems for Hypatia Board}}};
			\node[white,right] (Title) at (3,0) {\LARGE \textsf{\TRANS{SYDE}{SYDE}}};
