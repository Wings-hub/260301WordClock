...
\begin{center}
    \includegraphics[width=\textwidth]{../../Images/Bluetooth/BleBulletinBoardModel}
...
\begin{center}
    \includegraphics[width=\textwidth]{../../Images/Bluetooth/AndroidMenu}
...
\begin{center}
  \includegraphics[width=\textwidth]{../../Images/BlueTooth/BlueToothApp01}
...
\begin{center}
  \includegraphics[scale=0.3]{../../Images/BlueTooth/BlueToothApp02}
  \captionof{figure}of{center}{App nRF  is searching the Arduino Nano BLE Sense}
\end{center}
...
\begin{center}
  \includegraphics[scale=0.3]{../../Images/BlueTooth/BlueToothApp03}
...
\begin{center}
  \includegraphics[width=\textwidth]{../../Images/Bluetooth/BatteryApp}
...
\begin{center}
    \centering
    \includegraphics[width=0.6\textwidth]{../../Images/Bluetooth/BatteryAppAcc}
    \captionof{figure}{nRF Connect Screen}    
\end{center}

\begin{center}
    \centering
    \includegraphics[width=0.6\textwidth]{../../Images/Bluetooth/BatteryAppAcc2}
...
\begin{center}
    \includegraphics[width=0.7\linewidth]{../../Images/Nano33BLESense/TestsoftwareBluetooth}
...
\begin{center}
	\includegraphics[width=0.75\textwidth]{../../Images/Bluetooth/BluetoothLogo}
