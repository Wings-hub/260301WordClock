...
\subsection{Ausgabe des ROM-Codes und der im Speicher abgelegten oberen und unteren Alarmschwellen}
	...
	
	{
		...
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/dsSearchAndPrintSerialNummer.cpp}
...
\subsection{Temperatur Auslesen}
	...
	
	{
		...
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/dsRequestTemperature.cpp}
	}
...
\section{Einfache Applikation}
	...
	\begin{itemize}
		\item \PYTHON{SerialUtils.h} / \PYTHON{SerialUtils.cpp} — Funktionen für serielle Ein- und Ausgaben,  
		\item \PYTHON{Messages.h} / \PYTHON{Messages.cpp} — zentrale Verwaltung der Textnachrichten,  
		\item \PYTHON{CValidators.h} / \PYTHON{CValidators.cpp} — Validierung und Verarbeitung von Benutzereingaben,  
		\item \PYTHON{CDS18B20Sensors.h} / \PYTHON{CDS18B20Sensors.cpp} — objektorientierte Bibliothek zur Verwaltung der DS18B20-Sensoren.
	\end{itemize}
	
	Durch diese modulare Struktur können beide Hauptprogramme — \PYTHON{mainSetup.cpp} (Konfiguration)  
	und \PYTHON{mainMonitor.cpp} (Überwachung) — dieselbe logische Basis verwenden und bleiben dennoch unabhängig voneinander kompilierbar.
	
	{
		\captionof{code}{Header-Datei der Nachrichtenverwaltung}
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/Messages.h}
	}
	
	{
		\captionof{code}{Implementierungsdatei der Nachrichtenverwaltung}
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/Messages.cpp}
	}
	
	{
		\captionof{code}{Header-Datei mit Hilfsfunktionen für serielle Ein- und Ausgaben}
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/SerialUtils.h}
	}
	
	{
		\captionof{code}{Implementierungsdatei der Hilfsfunktionen für serielle Ein- und Ausgaben}
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/SerialUtils.cpp}
	}
	
	{
		\captionof{code}{Header-Datei mit Funktionen zur Eingabevalidierung}
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/CValidators.h}
	}
	
	{
		\captionof{code}{Implementierungsdatei der Funktionen zur Eingabevalidierung}
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/CValidators.cpp}
	}
	
	{
		...
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/CDS18B20Sensors.h}
	}
	
	{
		\captionof{code}{Implementierungsdatei der Bibliothek \PYTHON{CDS18B20Sensors}}
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/CDS18B20Sensors.cpp}
	}
...
\subsection{Programm 1: Einstellung der oberen und unteren Alarmschwellengrenzen}
	...
	
	{
		...
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/mainSetup.cpp}
	}
...
\subsection{Programm 2: Überwachung der DS18B20-Sensoren am 1-Wire-Bus}
	...
	
	{
		...
		\ArduinoExternal{}{../../../MKRWAN1310/Code/MKRWAN1310/DS18B20/mainMonitor.cpp}
	}
