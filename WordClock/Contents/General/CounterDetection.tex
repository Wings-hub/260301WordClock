...
Harnessing the above concepts, \cite{Sparber:2020,JHTECH:2017,List:2021} built systems as part of automating their homes for meter readings. This implies it is quite cheap and simple to have a smart meter just by using a device with an integrated camera and an appropriate TinyML framework. One of the advantages of a digital meter is that you won't have to manually check the readings to monitor the usage, instead, you will get an automated notification from your smart meter when you are about to reach the limit. The use cases mentioned above include capturing an image of the meter counter and identifying the readings of the meter. This involves image recognition, \ac{ocr}, and data augmentation using \ac{tfl}.
