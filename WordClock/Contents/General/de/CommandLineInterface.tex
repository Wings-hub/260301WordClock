...
Da \ac{cli} ständig weiterentwickelt wird, muss zunächst die aktuelle Version aus dem GitHub-Projekt \url{https://arduino.github.io/arduino-cli/0.22/installation/#latest-release}, siehe \cite{ArduinoCLIGit:2022},  geladen werden.
% https://github.com/arduino/arduino-cli#download-the-latest-unstable-alpha-preview.
Die heruntergeladene zip-Datei mit der Bezeichnung \FILE{arduino-cli\_0.22.1\_Windows\_64bit} in dem gewünschten Ordner. Dieser Pfad muss in der Liste der Umgebungsvariablen auf unserem Computer hinzugefügt werden. Nachdem wir den Pfad hinzugefügt haben, muss in einer Kommandozeile  das Kommando \SHELL{arduino-cli} aufgerufen werden. Die Installation startet dann. Nachdem die Installation abgeschlossen ist, kann \SHELL{arduino-cli board list} in der Eingabeaufforderung eingegeben werden. Das angeschlossene Gerät wird als Arduino Portenta H7\index{Portenta H7} mit Portnummer und Typ angezeigt, wie in Abbildung \ref{ArduinoInstallation} dargestellt. Es ist zu beachten, dass die Versionsnummer, hier 0.22.1, gegebenenfalls anzupassen ist. Wenn eine Nicla Vision\index{Nicla Vision} angeschlossen ist, werdne entsprechende Meldungen ausgegeben.
Das Programm \FILE{arduino-cli-0.22.1.windows.exe} wird nun in \FILE{arduino-cli.exe} umbenannt. Daher kann im Folgenden im der Programmname \FILE{arduino-cli.exe} verwendet werden.
